...
#'   \code{I(x1^2)}. If Y takes discrete integer values, the as.factor() command 
#'   will order automatically order the values. 
#'   If Y takes on values composed of character strings, such as “strongly agree”, “agree”, and “disagree”, 
#'   as.factor() will order the values in the order in which they appear in Y. 
#'   You will need to replace your dependent variable with a factored variable prior to 
#'   estimating the model through zelig(). See the example below for more details.
...
#'
#'
#' @seealso Vignette: \url{http://docs.zeligproject.org/articles/zeligchoice_oprobit.html}
#' @import methods
#' @export Zelig-ologit
