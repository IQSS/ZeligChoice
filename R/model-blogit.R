...
#' library(zeligverse) 
#' data(sanction)
#' z.out1 <- zelig(cbind(import, export) ~ coop + cost + target,model = "blogit", data = sanction)
#' 
#' @details
...
#'
#' @seealso Vignette: \url{http://docs.zeligproject.org/articles/zeligchoice_blogit.html}
#' @import methods
#' @export Zelig-blogit
