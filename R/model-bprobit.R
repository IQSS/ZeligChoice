...
#' library(zeligverse) 
#' data(sanction)
#' z.out1 <- zelig(cbind(import, export) ~ coop + cost + target,model = "bprobit", data = sanction)
#' 
#' @details
...
#'
#'
#' @seealso Vignette: \url{http://docs.zeligproject.org/articles/zeligchoice_bprobit.html}
#' @import methods
